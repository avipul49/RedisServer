...
public class Adpcm {
	...
	public static void main(String[] args) throws IOException, DataFormatException {
		...
		byte[] o = decompress(compress(input));
		// byte[] output = new byte[1024];
		// int s = adpcm.code(state, input, 0, 512, output, 0);
		// // adpcm = new Adpcm();
		// // state = adpcm.new AdpcmState();
		// short[] o = new short[512];
		// s = adpcm.decode(state, output, 0, s, o, 0);
		//
